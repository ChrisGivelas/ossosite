    ...
    return (
            ...
            if (!this._isBusy()) {
                ...
                return (
                    ...
                    h
                        ...
                        : ("function" == typeof t.opts.onOpen && t.opts.onOpen.call(t), t._busy(!1)),
                    this.checkOverflow(),
                    this
                )
            }
        ...
        (t.prototype.close = function(t) {
            if (!this._isBusy()) {
                ...
                var o = this
                t
                    ? ((o.modal.style.display = "none"),
                      "function" == typeof o.opts.onClose && o.opts.onClose.call(this),
                      o._busy(!1))
                    : h
                    ? this.modal.addEventListener(
                          h,
                          function t() {
                              o.modal.removeEventListener(h, t, !1),
                                  (o.modal.style.display = "none"),
                                  "function" == typeof o.opts.onClose && o.opts.onClose.call(this),
                                  o._busy(!1)
                          },
        ...
        (t.prototype.checkOverflow = function() {
            this.modal.classList.contains("tingle-modal--visible") &&
                ...
                !this.isOverflow() && this.opts.stickyFooter
                    ...
                    : this.isOverflow() && this.opts.stickyFooter && (o.call(this), this.setStickyFooter(!0)))
        }),
        { modal: t }
    )
})
